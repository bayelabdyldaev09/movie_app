        ...
        builder: (context, state) {
          return SingleChildScrollView(
            child: Column(
              children: [
                Padding(
                  padding: const EdgeInsets.only(top: 42, bottom: 95),
                  child: welcome,
                ),
                SizedBox(
                  width: 370,
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                        color: state is AuthError && state.emailError != null
                      ...
                      focusedErrorBorder: outlineInputBorder(Color(0xFFB91C21)),
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 23, bottom: 58),
                  child: richText,
                ),
              ],
            ),
